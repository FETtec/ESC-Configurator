...
# Some definitions
!define SOURCE_FILES          "..\..\apps\fettec-esc-config\${PLATFORM}\*"
!define APP_NAME              "FETtec ESC Configurator"
!define COMPANY_NAME          "FETtec"
!define GROUP_NAME            "FETtec"
!define FOLDER_NAME           "fettec-esc-config"
!define FILE_NAME_INSTALLER   "fettec-configurator-installer_${VERSION}_${PLATFORM}.exe"
!define FILE_NAME_UNINSTALLER "uninstall-fettec-configurator.exe"
!define FILE_NAME_EXECUTABLE  "fettec-esc-config.exe"
...
# set the icon
!define MUI_ICON ".\fettec-installer_icon.ico"
!define MUI_UNICON ".\fettec-installer_icon.ico"

#Define uninstall list name
!define UninstName "uninft00"
