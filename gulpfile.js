...
var nwBuilderOptions = {
    version: '0.36.4',
    files: './dist/**/*',
    macIcns: './src/images/icon_128.icns',
    macPlist: { 'CFBundleDisplayName': 'FETtec ESC Configurator' },
    //    winIco: './src/images/icon_128.ico',
    zip: false
};
...
function getReleaseFilename(platform, ext) {
    return pkg.name + '_' + pkg.version + '-' + git.branch() + '_' + git.short() + '-' + platform + '.' + ext;
}
        ...
        .pipe(appdmg({
            ...
            specification: {
                ...
                contents: [
                    ...
                    { 'x': 192, 'y': 344, 'type': 'file', 'path': pkg.name + '.app', 'name': 'FETtec ESC Configurator.app' }
                ],
